...
contract ChainlinkScript is Script {
    ...
    function run() public {
        vm.startBroadcast();
        // arbitrum sepolia
        uint64 subscriptionId = 30267214356765260478491562931478314358894768148389424553055604642560192273695;
        ...
        VRFDraw = new VRFDraw(subscriptionId, vrfCoordinator, link, keyHash, callbackGasLimit);
        vm.stopBroadcast();
    }
}
